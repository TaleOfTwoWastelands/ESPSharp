...
{
	public partial class LightingTemplateData : Subrecord, ICloneable, IComparable<LightingTemplateData>, IEquatable<LightingTemplateData>  
	{
		...
		public LightingTemplateData(string Tag = null)
			:base(Tag)
		{
