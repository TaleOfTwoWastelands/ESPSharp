...
{
	public partial class AcousticSpaceCopy : Record, IEditorID
	{
		...
		public AcousticSpaceCopy(SimpleSubrecord<String> EditorID, ObjectBounds ObjectBounds, List<RecordReference> Sounds, SimpleSubrecord<UInt32> WallaTriggerCount, RecordReference UseSoundFromRegion, SimpleSubrecord<EnvironmentType> EnvironmentType, SimpleSubrecord<IsInteriorEnum> IsInterior)
		{
		...
		public AcousticSpaceCopy(AcousticSpaceCopy copyObject)
		{
					}
		...
		public AcousticSpaceCopy Clone()
		{
			return new AcousticSpaceCopy(this);
		}
