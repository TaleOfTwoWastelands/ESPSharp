...
namespace ESPSharp.Records
{
	public partial class LeveledNPC : Record, IEditorID
	{
		...
		public LeveledNPC(SimpleSubrecord<String> EditorID, ObjectBounds ObjectBounds, SimpleSubrecord<Byte> ChanceNone, SimpleSubrecord<LeveledListFlags> LeveledObjectFlags, List<LeveledListEntry> LeveledList, Model Model)
		{
		...
		public LeveledNPC(LeveledNPC copyObject)
		{
					}
		...
		public LeveledNPC Clone()
		{
			return new LeveledNPC(this);
		}
